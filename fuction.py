...
def gethtml(url):
    try:
        kw={'cookie':'BIDUPSID=BF957DA748CC35F77B490649EC79264E; PSTM=1584514470; BAIDUID=BF957DA748CC35F77A60EE8D1EDF63E2:FG=1; BDORZ=B490B5EBF6F3CD402E515D22BCDA1598; BDUSS=zlJRklVMWJQcWRRaXNtfldzOG5lakZ5RS13Tk5YT2RxaDVTQnR3YXRTamhxNWxlSVFBQUFBJCQAAAAAAAAAAAEAAAAjHR67AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAOEecl7hHnJeU; BDRCVFR[feWj1Vr5u3D]=I67x6TjHwwYf0; delPer=0; PSINO=5; H_PS_PSSID=1435_31121_21124_30839_31186_30905_30823_31086_26350_31195',
            'user-agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Safari/537.36'}
        response =requests.get(url,headers = kw,timeout=30)
...
def parsehtml(html):
    ...
    # res =etree.HTML(html)
    # img = res.xpath('//img[@class="large"]/@src')[0]
    # print(result)

def main():
    url = 'https://mbd.baidu.com/newspage/data/landingsuper?context=%7B%22nid%22%3A%22news_9828382965785399916%22%7D&n_type=0&p_from=1'
    # url = 'https://mbd.baidu.com/newspage/api/getusername?cb=jQuery110205344146231815143_1585448338589&_=1585448338590'
    html = gethtml(url)
